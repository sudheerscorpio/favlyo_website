    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 order-1 order-lg-2 details-2" data-aos="zoom-out" data-aos-delay="300">
          ...
          <img alt="Favlyo Hero - Fashion Happiness" class="img-fluid animated" src="assets/img/Try_10.jpg" />
        </div>
      </div>
    </div>
    ...
    <section class="details" id="details">
      <div class="container">
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right"><img alt="Favlyo Seamless Shopping" class="img-fluid"
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left"><img alt="Favlyo Cumulative Selections"
              class="img-fluid" src="assets/img/details-2.png" /></div>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right"><img alt="Favlyo Extensive Line of Products" class="img-fluid"
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left"><img alt="Favlyo Supreme Stores"
              class="img-fluid" src="assets/img/details-4.png" /></div>
        ...
        <div class="row" data-aos="fade-left">
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img alt="Favlyo Team Founder" class="img-fluid" src="assets/img/team/team-1.jpg" />
              </div>
