...
<head>
  ...
  <meta content="" name="keywords"><!-- Favicons --><!-- <link href="assets/img/favicon.png" rel="icon"> -->
...
<body><!-- ======= Header ======= -->
  <header class="fixed-top d-flex align-items-center header-transparent" id="header">
    <div class="container d-flex align-items-center justify-content-between">
      <div class="logo"><!--        <h1><a href="index.htm"><span>FAVLYO</span></a></h1> -->
        <h1><a href="#hero"><span>FAVLYO</span></a></h1>
  ...
  <section id="hero">
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 order-1 order-lg-2 details-2" data-aos="zoom-out" data-aos-delay="300">
          <!-- <img src="assets/img/hero-img.png" class="img-fluid animated" alt=""> -->
          <img alt="" class="img-fluid animated" src="assets/img/Try_10.jpg" />
        </div>
      </div>
    </div>
  ...
  <main id="main"><!-- ======= About Section ======= -->
    ...
    <section class="details" id="details">
      <div class="container">
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right"><img alt="" class="img-fluid" src="assets/img/details-1.png" />
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left"><img alt="" class="img-fluid"
              src="assets/img/details-2.png" /></div>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right"><img alt="" class="img-fluid" src="assets/img/details-3.png" />
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left"><img alt="" class="img-fluid"
              src="assets/img/details-4.png" /></div>
    ...
    <section class="gallery" id="gallery">
      <div class="container">
        ...
        <div class="row g-0" data-aos="fade-left">
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-1.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-1.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-2.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-2.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-3.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-3.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-4.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-4.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-5.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-5.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-6.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-6.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-7.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-7.jpg" /> </a></div>
          </div>

          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450"><a class="gallery-lightbox"
                href="assets/img/gallery/gallery-8.jpg"><img alt="" class="img-fluid"
                  src="assets/img/gallery/gallery-8.jpg" /> </a></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="contact" id="contact">
      <div class="container">
        ...
        <div>
          <iframe style="border:0; width: 50%; height: 270px;" <!--
  ...
  <script>
    $(document).ready(function () {
      $('#register-form').on('submit', function (e) {
        e.preventDefault();
        var form = $(this);
        var responseContainer = $('#register-response');

        responseContainer.html('<div class="alert alert-info">Submitting...</div>');
        ...
        $.ajax({
          ...
          success: function (response) {
            if (response.trim() === 'success') {
              responseContainer.html('<div class="alert alert-success">Registration successful! Thank you.</div>');
              form[0].reset();
            } else {
              responseContainer.html('<div class="alert alert-danger">' + response + '</div>');
            }
          },
          error: function () {
    ...
    $(document).ready(function () {
      $('#contact-form').on('submit', function (e) {
        ...
        $.ajax({
          ...
          data: formData,
          success: function (response) {
            $('#contact-response').html('<div class="alert alert-success">Message sent successfully!</div>');
            $('#contact-form')[0].reset(); // Reset the form
          },
          error: function () {
            $('#contact-response').html('<div class="alert alert-danger">There was an error sending your message. Please try again later.</div>');
          }
        });
      });
    }); 
  ...
  <script>
    ...
    $(document).ready(function () {
      var $languagesSelect = $('#languages');
      indianLanguages.sort().forEach(function (lang) {
        $languagesSelect.append($('<option>', { value: lang, text: lang }));
      });
    });
  </script>

  <script>
    // City-State mapping (add more as needed)
    const cityStateMap = {
      // Andhra Pradesh
    ...
    $(document).ready(function () {
      ...
      var $citySelect = $('#city');
      indianCities.sort().forEach(function (city) {
        $citySelect.append($('<option>', { value: city, text: city }));
      });

      // Auto-populate state based on city selection
  ...
  <script>
    $(document).ready(function () {
      // Only sort options for "What are you" select field
      var $roleSelect = $('select[name="role"].form-control');
      if ($roleSelect.length) {
        var options = $roleSelect.find('option:not(:first)').sort(function (a, b) {
  ...
  <!-- Sorting the field options in ascending order -->
  <script>
    $(document).ready(function () {
      ...
      if (form) {
        form.onsubmit = function (e) {
          ...
          fetch(form.action, { method: 'POST', body: data })
            .then(r => {
              if (!r.ok) {
                // If response is not ok (e.g., 404), throw error
                throw new Error('Registration service not available (404)');
              }
              return r.text();
            })
            .then(msg => {
            ...
            .catch(err => {
              document.getElementById('register-response').innerHTML =
                '<div class="alert alert-danger">Registration failed: ' + err.message + '</div>';
            });
        };
      }
    });
